...
const Widget = () => {
    ...
    const getWidgetVariables = () => {
        fetch('http://localhost:9000/v1/dashboard/widget-variables', {credentials: 'include'})
        .then(res => res.json())
        .then(data => {
            if(data.status){
    ...
    const updateTheme = () => {
        fetch('http://localhost:9000/v1/dashboard/update-theme', {
            mode: 'cors',
            method: 'POST',
            credentials: 'include',
    ...
    const updateVariables = () => {
        ...
        if(insurance !== '' && deliveryRoundTrip !== '' && deliveryOne !== '' && gasPrepayment !== '' &
            ...
            fetch('http://localhost:9000/v1/dashboard/update-variables', {
                mode: 'cors',
                method: 'POST',
                credentials: 'include',
                headers: {'Content-Type': 'application/json', 'Accept': 'application/json', 'Origin': 'http://localhost:3000'},
    ...
    const getPrimaryColor = () => {
        fetch('http://localhost:9000/v1/widget/get-variables',{
            mode: 'cors',
            method: 'POST',
            headers: {'Content-Type': 'application/json', 'Accept': 'application/json', 'Origin': 'http://localhost:3000'},
